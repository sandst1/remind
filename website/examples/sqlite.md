...
Copy the example config from the [repository’s `examples/sqlite` folder](https://github.com/sandst1/remind/tree/main/examples/sqlite) to either the global or project-local location:
...
See the [postgres-docker example on GitHub](https://github.com/sandst1/remind/tree/main/examples/postgres-docker) to get started with PostgreSQL.
