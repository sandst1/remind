...
- **Entity type reference guide in `remind-capture` skill** — Table of all entity types (`file`, `function`, `class`, `module`, `person`, `concept`, `tool`, `project`) with examples and naming guidelines.
